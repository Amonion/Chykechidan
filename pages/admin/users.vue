    ...
    <div class="das-tb-flow">
      <div class="das-tb">
        <div class="das-tb-ead">
          ...
          <div class="das-tb-cell">Purchased</div>
        ...
        >
          ...
          <div class="das-tb-cell">
            N{{ formatNumber(item.totalPurchase * 1) }}
          </div>
          <div class="das-tb-cell _20">
            {{ formatDateToTime(item.dateCreated * 1000) }} <br />
            {{ formatNumberToDate(item.dateCreated * 1000) }}
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    setPositions(users) {
      for (let i = 0; i < users.length; i++) {
        const el = users[i];
        el.position = this.selectedPosition;
      }
      return users;
    },
  ...
  computed: {
    ...
    userStatus() {
      return this.$store.state.admin.userStatus;
    },
