...
export default {
  ...
  methods: {
    ...
    async getTransactions() {
      const query = `/transactions/?limit=${this.limit}&page=${this.currentPage}&sort=${this.sort}${this.timeFrom}${this.timeTo}${this.transactionQuery}&username=${this.user.username}`;
